...
const useStyles = createStyles((theme: MantineTheme, { floating }: { floating: boolean }) => ({
  root: {
    position: "relative",
  },
...
export default function LoginForm(): JSX.Element {
  ...
  const { classes } = useStyles({
    floating: form.values.email.trim().length !== 0 || form.values.password.trim().length !== 0 || focused,
  });
